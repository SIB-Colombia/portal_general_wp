...
// Fonts
			...
			$typography_mixed_fonts["Grand Hotel"] = "Grand Hotel *";
...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '15px', 'lineheight' => '25px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#474747'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '72px', 'lineheight' => '86px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '54px', 'lineheight' => '65px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '42px', 'lineheight' => '50px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '43px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '28px', 'lineheight' => '34px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '25px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '52px', 'lineheight' => '52px', 'face' => 'Grand Hotel', 'style' => 'normal', 'character'  => 'latin', 'color' => '#feb487'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '17px', 'lineheight' => '20px', 'face' => 'Quicksand', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
		...
		$options['dribbble'] = array(
							"name" => __('Dribble URL', CURRENT_THEME),
							"desc" => __('Dribble URL', CURRENT_THEME),
							"id" => "dribbble",
							"std" => "#",
							"type" => "text"
		);
		$options['behance'] = array(
							"name" => __('Behance URL', CURRENT_THEME),
							"desc" => __('Behance URL', CURRENT_THEME),
							"id" => "behance",
							"std" => "#",
							"type" => "text"
		);
