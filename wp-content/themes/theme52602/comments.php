...
<!-- BEGIN Comments -->	
	...
	<p class="comment_submit">
		<input name="submit" type="submit" class="btn btn-primary" id="submit" tabindex="5" value="<?php echo __('Send', CURRENT_THEME); ?>" />
		<input type="reset" value="<?php echo theme_locals("clear"); ?>" class="btn btn-primary" />
