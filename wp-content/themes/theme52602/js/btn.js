jQuery(document).ready(function(jQuery) {
	...
	jQuery('input[type="submit"]').each(function(){
		if(!jQuery(this).hasClass('adminbar-button') && !jQuery(this).hasClass('search-form_is')) {
			jQuery(this).wrap('<span class="input-btn btn '+btn_hover+' orange"><span></span></span>').removeClass('btn').removeClass('btn-primary');
		};
	});
	jQuery('input[type="reset"]').each(function(){
		if(!jQuery(this).hasClass('adminbar-button') && !jQuery(this).hasClass('search-form_is')) {
			jQuery(this).wrap('<span class="input-btn btn '+btn_hover+' gray"><span></span></span>').removeClass('btn').removeClass('btn-primary');
		};
	});
