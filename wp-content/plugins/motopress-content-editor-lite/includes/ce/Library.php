...
/* BUTTON */
	    $buttonParameters = array(
            ...
            'full_width' => array(
                'type' => 'checkbox',
                'label' => $motopressCELang->CEFullWidthButton,
                'default' => 'false',
                'disabled' => 'false'
            ),
            'align' => array(
...
/* MODAL */
        $modalObj = new MPCEObject(MPCEShortcode::PREFIX . 'modal', $motopressCELang->CEModalObjName, "modal.png", array(
            ...
            'button_full_width' => array(
                'type' => 'checkbox',
                'label' => $motopressCELang->CEFullWidthButton . ' ' . $motopressCELang->CEButtonObjName,
                'default' => 'false'
            ),
            'button_align' => array(
                'type' => 'radio-buttons',
...
function getMotopressCELibrary(){
    //TODO: MPCELibrary must be singleton. Global variable $motopressCELibrary must be removed.
    global $motopressCELibrary;
    if (!isset($motopressCELibrary) || !is_a($motopressCELibrary, 'MPCELibrary')) {
        $motopressCELibrary = new MPCELibrary();
    }
    return $motopressCELibrary;
}
